...
public class Paillier {
	...
	public void KeyGeneration(int bitLengthVal, int certainty) {
		...
		System.out.println("bitLength:  " + (Integer.valueOf(bitLength).toString().length()) + " : " + bitLength);
		System.out.println("p:  " + (p.toString().length()) + " : "  + p);
		System.out.println("q:  " + (q.toString().length()) + " : "  + q);
		System.out.println("n:  " + (n.toString().length()) + " : "  + n);
		System.out.println("nsquare:  " + (nsquare.toString().length()) + " : "  + nsquare);
		System.out.println("g:  " + g);
		System.out.println("lambda:  " + (lambda.toString().length()) + " : "  + lambda);

		System.out.println("gs: " +
				g.modPow(lambda, nsquare).subtract(BigInteger.ONE).divide(n).gcd(n).intValue()
		);
	...
	public static void main(String[] str) {
		...
		BigInteger m2 = new BigInteger("1615");
		/* encryption */
...
//		System.out.println("m1*m2 : " + (m1.multiply(m2)).toString());
...
//		//sum test
		...
		System.out.println("sum1 => " + p.Decryption(sum).toString());
		sum = p.cipher_add(sum, et2);
		System.out.println("sum2 => " + p.Decryption(sum).toString());
		sum = p.cipher_add(sum, et3);
		System.out.println("sum3 => " + p.Decryption(sum).toString());

		BigInteger s = sum.multiply(et3).mod(p.nsquare);

		System.out.println("sum: "+sum.toString());
		System.out.println("decrypted sum: "+p.Decryption(sum).toString());

		System.out.println("sss sum: " + p.Decryption(s).toString());
		System.out.println("--------------------------------");
...
//			BigInteger encryption = p.Encryption(new BigInteger("1"));
//			list.add(encryption.toString());
//		}
//
...
//
//			BigInteger decryption = p.Decryption(new BigInteger(list.get(i)));
//			if(!decryption.toString().equals("1")) {
//				System.out.println(list.get(i) + "  =>  " + decryption);
//			}
//
//		}
//
...
//		sum = p.cipher_add(sum, et1);
//
//		BigInteger s = sum.multiply(et1).mod(p.nsquare);
//
//		System.out.println(p.Decryption(s));
